...
<head>
    ...
    <style>
        ...
        .table {
            ...
            /* Ensures borders are collapsed into a single line */
            margin: 20px 0;
            /* Adds some space around the table */
            font-family: Arial, sans-serif;
            /* Sets a clean font for the table */
        }
        ...
        .table td {
            ...
            /* Align text to the left */
            font-size: 1em;
            /* Regular font size for table cells */
        }
        ...
        .table td {
            ...
            /* Light grey border for the table */
        }
        ...
        .btn button:hover {
            ...
            /* Darker shade of blue when hovering */
        }
    </style>
</head>
...
<body>
  ...
  $data = "DELETE FROM `types` WHERE `tid` = $del";
        ...
        <tbody id="tablebody">
            ...
            if ($row > 0) {
                ...
                while ($data = mysqli_fetch_assoc($result)) {
                    $checkrs = "SELECT * FROM `check` WHERE `producttype` = $data[tid]";
                        ...
                        <td>
                         ...
                         if($product_count == 0){
                            ...
                            <form action="" method="POST">
                                <input type="hidden" name="delete_id" value="<?= $data['tid']; ?>"> 
